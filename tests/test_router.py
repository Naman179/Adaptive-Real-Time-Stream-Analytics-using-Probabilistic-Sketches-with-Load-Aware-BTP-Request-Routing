...
def make_metrics(template="medium", p95=10.0, memory_pct=30.0):
...
class TestRouterScoring:
    ...
    def test_high_template_scores_higher_than_low(self):
        ...
        high = make_metrics("high",   p95=10, memory_pct=20)
        low  = make_metrics("low",    p95=10, memory_pct=20)
    ...
    def test_lower_latency_scores_higher(self):
        ...
        fast = make_metrics("medium", p95=5,  memory_pct=30)
        slow = make_metrics("medium", p95=100, memory_pct=30)
    ...
    def test_higher_memory_scores_lower(self):
        ...
        free = make_metrics("medium", p95=10, memory_pct=10)
        full = make_metrics("medium", p95=10, memory_pct=90)
    ...
    def test_rank_nodes_returns_sorted_list(self):
        ...
        cluster = {
            "w0": make_metrics("high",   p95=5,   memory_pct=10),
            "w1": make_metrics("low",    p95=200, memory_pct=80),
            "w2": make_metrics("medium", p95=50,  memory_pct=50),
        }
    ...
    def test_best_node_is_first(self):
        ...
        cluster = {
            "best_node":  make_metrics("high",   p95=3,   memory_pct=5),
            "worst_node": make_metrics("low",    p95=300, memory_pct=95),
        }
        ranked = self.router._rank_nodes(cluster, alpha_q=0.95, latency_sla_ms=50)
    ...
    def test_single_node_always_selected(self):
        ...
        cluster = {"only_worker": make_metrics("low", p95=999, memory_pct=99)}
        ranked = self.router._rank_nodes(cluster, alpha_q=0.95, latency_sla_ms=50)
        assert len(ranked) == 1
    ...
    def test_score_formula_correctness(self):
        ...
        m = make_metrics("medium", p95=10.0, memory_pct=40.0)
